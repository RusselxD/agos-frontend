...
const InfoBox = () => {
    return (
        <div className="flex items-start sm:items-center text-sm gap-2 bg-primary p-3 text-white rounded-md">
        ...
        <Container className="space-y-3" headerTitle="DATA RETENTION">
            ...
            {isLoading ? (
                <div className="space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 font-medium sm:items-center">
