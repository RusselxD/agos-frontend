        ...
        <footer className="border-t border-gray-200 bg-white relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    <div className="relative flex items-center justify-center w-8 h-8 bg-gray-50 rounded-lg border border-gray-200 shadow-sm">
                        <img
                            src="/agos.svg"
                            alt="AGOS Logo"
                    ...
                    <span className="font-bold text-slate-900 text-lg">AGOS</span>
                </div>
